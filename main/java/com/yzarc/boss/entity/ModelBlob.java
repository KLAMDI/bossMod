...
//	private ModelRenderer leg4;
    ...
    public ModelBlob(float p_i1147_1_)
    {
        byte b0 = 4;
        this.core = new ModelRenderer(this, 0, 0);
        this.core.addBox(0.0F, 16.0F, 0.0F, 8, 1, 8, p_i1147_1_);
...
//        this.leg4.render(p_78088_7_);
    ...
    {
        this.core.rotateAngleY = p_78087_4_ / (180F / (float)Math.PI);
        this.core.rotateAngleX = p_78087_5_ / (180F / (float)Math.PI);
